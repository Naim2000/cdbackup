...
#define PNGU_RGB8_TO_RGB5A3(r, g, b, a) (PNGU_u16)(((a & 0xE0U) == 0xE0U) ? (0x8000U | ((((PNGU_u16)r) & 0xF8U) << 7) | ((((PNGU_u16)g) & 0xF8U) << 2) | (((PNGU_u16)b) >> 3)) : (((((PNGU_u16)a) & 0xE0U) << 7) | ((((PNGU_u16)r) & 0xF0U) << 4) | (((PNGU_u16)g) & 0xF0U) | ((((PNGU_u16)b) & 0xF0U) >> 4)))
...
#define PNGU_DECODE_TO_COORDS_YCbYCr(ctx, coordX, coordY, imgWidth, imgHeight, bufferWidth, bufferHeight, buffer) \
                                                                                                                  \
	PNGU_DecodeToYCbYCr(ctx, imgWidth, imgHeight, ((void *)buffer) + (coordY) * (bufferWidth) * 2 + (coordX) * 2, (bufferWidth) - (imgWidth))
...
#define PNGU_DECODE_TO_COORDS_RGB565(ctx, coordX, coordY, imgWidth, imgHeight, bufferWidth, bufferHeight, buffer) \
                                                                                                                  \
	PNGU_DecodeToRGB565(ctx, imgWidth, imgHeight, ((void *)buffer) + (coordY) * (bufferWidth) * 2 + (coordX) * 2, (bufferWidth) - (imgWidth))
...
#define PNGU_DECODE_TO_COORDS_RGBA8(ctx, coordX, coordY, imgWidth, imgHeight, default_alpha, bufferWidth, bufferHeight, buffer) \
                                                                                                                                \
	PNGU_DecodeToRGBA8(ctx, imgWidth, imgHeight, ((void *)buffer) + (coordY) * (bufferWidth) * 2 + (coordX) * 2, (bufferWidth) - (imgWidth), default_alpha)
...
#define PNGU_ENCODE_TO_COORDS_YCbYCr(ctx, coordX, coordY, imgWidth, imgHeight, bufferWidth, bufferHeight, buffer) \
                                                                                                                  \
	PNGU_EncodeFromYCbYCr(ctx, imgWidth, imgHeight, ((void *)buffer) + (coordY) * (bufferWidth) * 2 + (coordX) * 2, (bufferWidth) - (imgWidth))
